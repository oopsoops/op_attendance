...
function getMeetingsAccept($accept) {
		switch($accept) {
			case	NULL:
				return '<img src="__TPL__/images/acceptnull.png" width="16" title="未定" />';
				break;
			case 1:
				return '<img src="__TPL__/images/accept1.png" width="16" title="同意" />';
				break;
			case 0:
				return '<img src="__TPL__/images/accept0.png" width="16" title="否定" />';
				break;
			default:
				return '<img src="__TPL__/images/acceptnull.png" width="16" title="未定" />';
				break;
