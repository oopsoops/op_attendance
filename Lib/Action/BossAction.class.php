...
class BossAction extends Action {
    ...
    public function boss_searchstaff() {
		...
		$rs = $info->field('op_staffinfo.uid as uid,op_staffinfo.username as  username ,op_staffinfo.phone as phone,op_department.departmentname as department,op_teaminfo.teamname as teamname')
